...
namespace Creek.UI.ProgressCursor
{
    public class ProgressCursor : IProgressCursor
    {
        ...
        #region IProgressCursor Members
        ...
        private Bitmap GenerateProgressBitmap(double value, double max)
        {
            ...
            var cursorPaintEventArgs = new CursorPaintEventArgs
                                           {Graphics = gfx, Handled = false, Max = Max, Value = Current};
        ...
        public class CursorPaintEventArgs : EventArgs
        {
            ...
            public void DrawDefault()
            {
                ...
                var textPoint =
                    new PointF(upperLeftInnerEllipsePoint.X + ((innerEllipseSize.Width - measureString.Width)/2),
                               upperLeftInnerEllipsePoint.Y + ((innerEllipseSize.Height - measureString.Height)/2));
